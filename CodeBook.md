...
The protocol is defined as follows:<br>
 - subjects in the test and train folder have been merged. Test data are on top of the table. Column name of the subjects is "Subjects" <br>
...
#2a. First I merge the X_train.txt and X_test.txt from the main folder
...
#2b. Here I merge the Y_train.txt and Y_test.txt from the main folder
...
Descriptive activity names have been added to name the activities in the data set. The activity names are the following: <br>
 - 1 WALKING <br>
